...
<?php else : ?>
				<?php
					$images = boilerplate_get_gallery_images();
					if ( $images ) :
				...
				<?php endif; // end boilerplate_get_gallery_images() check ?>
						<?php the_excerpt(); ?>
<?php endif; ?>
			</div><!-- .entry-content -->
			...
			<?php elseif ( $gallery = get_term_by( 'slug', _x( 'gallery', 'gallery category slug', 'boilerplate' ), 'category' ) && in_category( $gallery->term_id ) ) : ?> 
				<a href="<?php echo get_category_link( $gallery ); ?>" title="<?php esc_attr_e( 'View posts in the Gallery category', 'boilerplate' ); ?>"><?php _e( 'More Galleries', 'boilerplate' ); ?></a>
				<span class="meta-sep">|</span>
			<?php endif; ?>
