	...
	//	You get this if you click the left-column "Boilerplate Admin" (added above)
		...
		?>
			<div id="boilerplate-options-wrap">
				...
				<p>So, there's actually a tremendous amount going on here.  If you're not familiar with <a href="http://html5boilerplate.com/">HTML5 Boilerplate</a> or the <a href="http://wordpress.org/extend/themes/twentyten">Twenty Ten theme</a> (upon which this theme is based) you should check them out.</p>
...
/*	3)	Add "Boilerplate Admin" Page options */
	...
	//	callback fn for jquery_js
		function jquery_js_setting() {
			...
			echo '<code><b>&lt;</b>script src<b>=</b><span>\'http://ajax.googleapis.com/ajax/libs/jquery/1.7.1/jquery.min.js\'</span><b>&gt;&lt;/</b>script<b>&gt;</b></code>';
...
/*	4)	Create functions to add above elements to pages */
	...
	//	$options['jquery_js']
		function add_jquery_script() {
			...
			wp_register_script( 'jquery', 'http://ajax.googleapis.com/ajax/libs/jquery/1.7.1/jquery.min.js', array(), str_replace('?ver=','',$cache) );
...
/*	5)	Add Boilerplate options to page as requested */
		if (!is_admin() ) {
			...
			if (isset($options['footer_credit']) && $options['footer_credit'] && $options['footer_credit'] !== '' ) {
				add_action('boilerplate_credits', 'add_footer_credit');
			}
		}
