...
/*	3)	Add "Boilerplate Admin" Page options */
	...
	//	callback fn for jquery_js
		function jquery_js_setting() {
			...
			echo '<code><b>&lt;</b>script src<b>=</b><span>\'http://ajax.googleapis.com/ajax/libs/jquery/1.7.2/jquery.min.js\'</span><b>&gt;&lt;/</b>script<b>&gt;</b></code>';
...
/*	4)	Create functions to add above elements to pages */
	...
	//	$options['jquery_js']
		function add_jquery_script() {
			...
			wp_register_script( 'jquery', 'http://ajax.googleapis.com/ajax/libs/jquery/1.7.2/jquery.min.js', array(), str_replace('?ver=','',$cache) );
